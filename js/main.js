...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (searchBtn && searchOv) {
    ...
    const pages = [
      { t:'Bastion Sanguinaris', s:'The Crimson Bastion — Vampire Stronghold in Blackreach', u:'bastion.html', k:'bastion crimson vampire blackreach feast hall scarlet archive chimney' },
      { t:'Abagarlas', s:'Notes on the Passage Beyond — Ayleid Ruin', u:'abagarlas.html', k:'abagarlas ayleid coldharbour throne soul gem forge passage veil' },
      { t:'Creature-From-Beyond', s:'Sword-Singer Redoubt — Where the void grows thin', u:'creature.html', k:'creature beyond sword singer redoubt void wyrd' },
      { t:'New-Sheoth Palace', s:'Sheogorath\u2019s Palace — Under Construction', u:'index.html', k:'new sheoth palace sheogorath mania dementia shivering isles' },
      { t:'The Craft Behind the Stone', s:'Environmental Storytelling \u00b7 Structural Intent', u:'index.html#craft', k:'craft storytelling structural intent builder' },
      { t:'Visit the Archive', s:'Lore documents \u2014 illustrated, themed, PDFs', u:'index.html#archive', k:'archive lore documents pdf' },
      { t:'News', s:'Latest announcements from the Archives', u:'news.php', k:'news announcements updates posts' },
      { t:'Login / Register', s:'Enter the Archives \u2014 join the community', u:'login.php', k:'login register account sign up enter' },
      { t:'Contact Andrey', s:'Reviews, problems, visual creations', u:'contact.php', k:'contact andrey message email support' },
    ];
